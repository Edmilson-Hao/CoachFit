...
import { getFirestore, collection, addDoc, query, where, getDocs, doc, updateDoc } from "https://www.gstatic.com/firebasejs/12.2.0/firebase-firestore.js";
...
export { auth, provider, signInWithPopup, onAuth, db, collection, addDoc, query, where, getDocs, doc, updateDoc };